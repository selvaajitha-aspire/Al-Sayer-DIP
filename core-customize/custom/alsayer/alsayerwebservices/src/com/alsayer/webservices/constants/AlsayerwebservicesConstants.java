 ...
 */
package com.alsayer.webservices.constants;

/**
 * Global class for all Alsayerwebservices constants. You can add global constants for your extension into this class.
 */
@SuppressWarnings({"deprecation","squid:CallToDeprecatedMethod"})
public final class AlsayerwebservicesConstants extends GeneratedAlsayerwebservicesConstants
{
	public static final String EXTENSIONNAME = "alsayerwebservices";
	...
	public static final String HOST = "alsayerwebservices.host";
	public static final String HOST_DEFAULT = "hostname";

	private AlsayerwebservicesConstants()
	{
