 ...
 */
package com.alsayer.v2.config;


import de.hybris.platform.servicelayer.config.ConfigurationService;
import de.hybris.platform.webservicescommons.swagger.services.ApiVendorExtensionService;
import com.alsayer.constants.YcommercewebservicesConstants;
import com.alsayer.request.mapping.handler.CommerceHandlerMapping;
...
{
	private static final String PASSWORD_AUTHORIZATION_SCOPE = "alsayercommercewebservices.oauth2.password.scope";
	private static final String CLIENT_CREDENTIAL_AUTHORIZATION_SCOPE = "alsayercommercewebservices.oauth2.clientCredentials.scope";
	private static final String AUTHORIZATION_URL = "alsayercommercewebservices.oauth2.tokenUrl";

	private static final String DESC = "alsayercommercewebservices.v2.description";
	private static final String TITLE = "alsayercommercewebservices.v2.title";
	private static final String VERSION = "alsayercommercewebservices.v2.version";
	private static final String LICENSE = "alsayercommercewebservices.v2.license";
	private static final String LICENSE_URL = "alsayercommercewebservices.v2.license.url";
