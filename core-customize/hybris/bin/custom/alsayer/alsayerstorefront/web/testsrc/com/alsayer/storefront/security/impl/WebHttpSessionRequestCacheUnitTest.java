...
public class WebHttpSessionRequestCacheUnitTest
{
	...
	public void testCalcRedirectUrlWithEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/alsayerstorefront/electronics/en",
						"https://electronics.local:9002/alsayerstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/alsayerstorefront/electronics/en",
						"https://electronics.local:9002/alsayerstorefront/electronics/en/"));
	...
	public void testCalcRedirectUrlWithMismatchEncodingAttrs()
	{
		assertEquals(
				"electronics/en",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/alsayerstorefront/electronics/ja/Y/Z",
						"https://electronics.local:9002/alsayerstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/alsayerstorefront/electronics/en",
						"https://electronics.local:9002/alsayerstorefront/electronics/en/"));
	}
	...
	public void testCalcRedirectUrlWithoutEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/alsayerstorefront",
						"https://electronics.local:9002/alsayerstorefront"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/alsayerstorefront",
						"https://electronics.local:9002/alsayerstorefront/"));
	...
	public void testCalcRedirectUrlWithEncodingAttrsServletPath()
	{
		assertEquals(
				...
				executeCalculateRelativeRedirectUrl("electronics/en", "/alsayerstorefront/electronics/en",
						"https://electronics.local:9002/alsayerstorefront/electronics/en/Open-Catalogue/Cameras/Digital-Cameras/c/575"));
	}
