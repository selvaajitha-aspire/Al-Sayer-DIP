 ...
 */
package com.alsayer.test.setup;
...
import com.alsayer.test.constants.AlsayerTestConstants;
import com.alsayer.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = AlsayerTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/alsayertest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/alsayertest/import/reviews.impex");

			LOG.info("Creating Test Payment Subscriptions...");
			getAcceleratorTestOrderData().createPaymentInfos();

			LOG.info("Creating CS Tickets...");
			importImpexFile(context, "/alsayertest/import/cstickets.impex");
			...
			importImpexFile(context, "/alsayertest/import/csquotes.impex");
		}
	}
}
