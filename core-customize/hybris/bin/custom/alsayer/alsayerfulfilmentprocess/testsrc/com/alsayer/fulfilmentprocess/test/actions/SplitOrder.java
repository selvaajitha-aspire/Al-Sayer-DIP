 ...
 */
package com.alsayer.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception
	{
		...
		warehouseCounter.setName(AlsayerFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(AlsayerFulfilmentProcessConstants.PARENT_PROCESS);
