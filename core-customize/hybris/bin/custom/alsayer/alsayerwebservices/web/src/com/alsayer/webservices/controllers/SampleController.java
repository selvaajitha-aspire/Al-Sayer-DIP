 ...
 */
package com.alsayer.webservices.controllers;

import static com.alsayer.webservices.constants.AlsayerwebservicesConstants.CLIENT_CREDENTIAL_AUTHORIZATION_NAME;
import static com.alsayer.webservices.constants.AlsayerwebservicesConstants.PASSWORD_AUTHORIZATION_NAME;
import static com.alsayer.webservices.constants.AlsayerwebservicesConstants.SAMPLE_LIST_DOUBLE_VALUE;
import static com.alsayer.webservices.constants.AlsayerwebservicesConstants.SAMPLE_LIST_STRING_VALUE;
...
import com.alsayer.webservices.data.UserDataList;
import com.alsayer.webservices.dto.SampleWsDTO;
import com.alsayer.webservices.dto.TestMapWsDTO;
import com.alsayer.webservices.dto.UserWsDTO;
import com.alsayer.webservices.dto.UsersListWsDTO;
import com.alsayer.webservices.dto.UsersPageWsDTO;
import com.alsayer.webservices.facades.SampleFacades;
...
public class SampleController
{
	 ...
	 * Example :</br>
	 * GET http://localhost:9001/alsayerwebservices/sample/dto/sampleValue
	 *
	 * @param pathVariable
	 ...
	 * Example :</br>
	 * URL : http://localhost:9001/alsayerwebservices/sample/dto</br>
	 * Method : POST</br>
	 ...
	 * <ul>
	 * <li>http://localhost:9001/alsayerwebservices/sample/users
	 * <li>http://localhost:9001/alsayerwebservices/sample/users?fields=users(info)
	 * <li>http://localhost:9001/alsayerwebservices/sample/users?fields=users(BASIC)
	 * <li>http://localhost:9001/alsayerwebservices/sample/users?fields=users(DEFAULT)
	 * <li>http://localhost:9001/alsayerwebservices/sample/users?fields=users(FULL)
	 * <li>http://localhost:9001/alsayerwebservices/sample/users?fields=users(firstName,addresses(street))
	 * </ul>
	 */
	 ...
	 * <ul>
	 * <li>http://localhost:9001/alsayerwebservices/sample/usersPaged
	 * <li>http://localhost:9001/alsayerwebservices/sample/usersPaged?currentPage=1
	 * <li>http://localhost:9001/alsayerwebservices/sample/usersPaged?currentPage=0?pageSize=1
	 * </ul>
	 */
	 ...
	 * <ul>
	 * <li>http://localhost:9001/alsayerwebservices/sample/users/user1
	 * <li>http://localhost:9001/alsayerwebservices/sample/users/user1?fields=info
	 * <li>http://localhost:9001/alsayerwebservices/sample/users/user1?fields=BASIC
	 * <li>http://localhost:9001/alsayerwebservices/sample/users/user1?fields=DEFAULT
	 * <li>http://localhost:9001/alsayerwebservices/sample/users/user1?fields=FULL
	 * <li>http://localhost:9001/alsayerwebservices/sample/users/user1?fields=firstName,addresses(street)
	 * </ul>
	 */
	 ...
	 *
	 * Url: http://localhost:9001/alsayerwebservices/sample/map
	 *
	 */
