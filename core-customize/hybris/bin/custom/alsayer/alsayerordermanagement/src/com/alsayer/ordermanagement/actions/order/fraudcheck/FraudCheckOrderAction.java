 ...
 *
 */
package com.alsayer.ordermanagement.actions.order.fraudcheck;
...
public class FraudCheckOrderAction extends AbstractFraudCheckAction<OrderProcessModel>
{
	...
	{
		final String value = Config.getParameter(AlsayerordermanagementConstants.EXTENSIONNAME + ".fraud." + property);
