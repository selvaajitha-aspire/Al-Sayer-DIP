...
package com.alsayer.ordermanagement.actions.returns;
...
public class TaxReverseAction extends AbstractSimpleDecisionAction<ReturnProcessModel>
{
	...
	public static final String TAX_REVERSE_FORCE_FAILURE = "alsayerordermanagement.reverse.tax.force.failure";
