 ...
 *
 */
package com.alsayer.ordermanagement.actions.order.payment;
...
import com.alsayer.ordermanagement.actions.order.payment.SendPaymentFailedNotificationAction;
...
public class SendPaymentFailedNotificationActionTest
{
	...
	/**
	 * Test method for
	 * {@link com.alsayer.ordermanagement.actions.order.SendPaymentFailedNotificationAction#executeAction(OrderProcessModel)}
	 * .
	 */
	@Test
