...
public class ReAllocateConsignmentActionTest
{
	...
	public void setup()
	{
		...
		when(orderBusinessProcessService
				.createProcess(anyString(), eq(AlsayerordermanagementConstants.CONSIGNMENT_SUBPROCESS_NAME)))
		...
		doNothing().when(orderBusinessProcessService)
				.triggerChoiceEvent(orderModel, AlsayerordermanagementConstants.ORDER_ACTION_EVENT_NAME,
