...
public class ReturnIntegrationTest extends BaseAcceleratorSourcingIntegrationTest
{
			...
			throws RetryLaterException, InterruptedException, ImpExException
	{
		...
		importCsv("/alsayerordermanagement/test/impex/email-content.impex", WarehousingTestConstants.ENCODING);
		importCsv("/alsayerordermanagement/test/impex/email-content_en.impex", WarehousingTestConstants.ENCODING);
